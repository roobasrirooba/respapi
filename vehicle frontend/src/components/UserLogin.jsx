          ...
          <div className={`user ${isSignIn ? 'signinBx' : 'signupBx'}`}>
            ...
            <div className="formBx">
              <form action="" onSubmit={(e) => e.preventDefault()}>
                ...
                <input type="submit" name="" value={isSignIn ? 'Login' : 'Sign Up'} onClick={loginUserBtn} />
                <p className="signup">
          ...
          <div className={`user ${isSignIn ? 'signupBx' : 'signinBx'}`}>
            <div className="formBx">
              <form action="" onSubmit={(e) => e.preventDefault()}>
                ...
                <input type="text" name="userName" placeholder="user name" value={registrationData.userName} onChange={handleChangeReg} />
                {!isSignIn && (
                  <input type="email" name="userEmail" placeholder="Email Address" value={registrationData.userEmail} onChange={handleChangeReg} />
                )}
                ...
                <button type="submit" onClick={registerUserBtn} >
